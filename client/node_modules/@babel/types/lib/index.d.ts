...
export function enumBooleanBody(members: Array<EnumBooleanMember>, explicit?: boolean | null): EnumBooleanBody;

export function enumNumberBody(members: Array<EnumNumberMember>, explicit?: boolean | null): EnumNumberBody;

export function enumStringBody(members: Array<EnumStringMember | EnumDefaultedMember>, explicit?: boolean | null): EnumStringBody;

export function enumSymbolBody(members: Array<EnumDefaultedMember>): EnumSymbolBody;

export function enumBooleanMember(id: Identifier, init?: BooleanLiteral | null): EnumBooleanMember;
