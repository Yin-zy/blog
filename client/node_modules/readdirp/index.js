...
const isNormalFlowError = error =
>
NORMAL_FLOW_ERRORS.has(error.code);
...
class ReaddirpStream extends Readable {
    ...
    _formatEntry(dirent, path) {
        ...
        try {
            entry[this._statsProp] = this._isDirent ? dirent : await
            this._stat(fullPath);
        } catch (err) {
            this._onError(err);
        }
