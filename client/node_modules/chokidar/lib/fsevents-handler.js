...
const canUse = () =
>
fsevents && FSEventsWatchers.size < 128;
...
class FsEventsHandler {
    ...
    checkFd(path, fullPath, realPath, parent, watchedDir, item, info, opts) {
        try {
            const fd = await
            open(path, FS_MODE_READ);
