(function (factory) {
    ...
    (function example() {
        ...
        await
        driver.navigate(config.testHost);
        await
        Async_1.Async.$delay(500);
        await
        tester.test('Test URL', () = > {
      ...
      `);
        ...
        ;
        await
        tester.test('Test URLSearchParams', () = > {
            return driver.executeScript(`
      ...
      `);
        ...
        ;
        await
        tester.test('Test URLSearchParams special char encoding/decoding', () = > {
            return driver.executeScript(`
      ...
      `);
        ...
        ;
        await
        tester.test('Test URLSearchParams constructor', () = > {
            return driver.executeScript(`
      ...
      `);
        ...
        ;
        await
        tester.test('Test URLSearchParams.sort', () = > {
            return driver.executeScript(`
        var a = new URLSearchParams('b=1&a=2&c=3');
        a.sort();
      ...
      `);
        ...
        ;
        await
        tester.test('Test URL with base', () = > {
            return driver.executeScript(`
      ...
      `);
        ...
        ;
        await
        tester.test('Test pathname variations', () = > {
            return driver.executeScript(`
      ...
      `);
        ...
        ;
        await
        tester.test('Ensure url.href does\'nt finish with ? if url.search is empty', () = > {
            return driver.executeScript(`
      ...
      `);
        ...
        ;
        await
        tester.test('URL SearchParams should have spaces encoded as "+"', () = > {
            return driver.executeScript(`
        var url = new URL('https://www.example.com/');
      ...
      `);
        ...
        ;
        await
        tester.test('Url Protocol should control the visibility of port in origin', () = > {
            return driver.executeScript(`
