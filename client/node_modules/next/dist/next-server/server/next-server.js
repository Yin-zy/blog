...
class Server {
    ...
    generateRoutes() {
        ...
        ;
        await
        this.serveStatic(req, res, p, parsedUrl);
        return {
            finished: true,
        };
    },
    ...
    :
        ...
        :
            '_next/data catchall',
                fn
        :
            async(req, res, params, _parsedUrl) =
        >
            {
                ...
                if (!params.path || params.path[0] !== this.buildId) {
                    await
                    this.render404(req, res, _parsedUrl);
                    return {
                        finished: true,
                    };
                }
                ...
                await
                this.render(req, res, pathname, {_nextSprData: '1'}, parsedUrl);
                return {
                    finished: true,
                };
            }
    ...
    ,
        ...
        :
            '_next catchall',
                ...
                fn
        :
            async(req, res, _params, parsedUrl) =
        >
            {
                await
                this.render404(req, res, parsedUrl);
    ...
    ...
        ...
        >
            (Object.assign(Object.assign({}, r), {type, matcher: getCustomRouteMatcher(r.source)}));
            const customRoutes = [
        ...
        ...
            ...
            routes.push(...customRoutes.map(route = > {
                return {
                    ...
                    let destinationCompiler = path_to_regexp_1.compile(route.destination);
            let newUrl;
            try {
        ...
        if (this.nextConfig.useFileSystemPublicRoutes) {
            ...
            await
            this.render(req, res, pathname, query, parsedUrl);
            return {
                finished: true,
            };
        },
    ...
    handleApiRequest(req, res, pathname) {
        ...
        await
        this.ensureApiPage(page);
        const builtPagePath = await
        ...
        await
        api_utils_1.apiResolver(req, res, params, pageModule, this.onErrorMiddleware);
    }
    ...
    render(req, res, pathname, query = {}, parsedUrl) {
        ...
        const html = await
        this.renderToHTML(req, res, pathname, query, {
    ...
    findPageComponents(pathname, query = {}) {
        const serverless = !this.renderOpts.dev && this._isLikeServerless;
        // try serving a static AMP version first
        if (query.amp) {
            try {
                return await
                load_components_1.loadComponents(this.distDir, this.buildId, (pathname === '/' ? '/index' : pathname) + '.amp', serverless);
            } catch (err) {
                if (err.code !== 'ENOENT')
                    throw err;
            }
        ...
        return await
        load_components_1.loadComponents(this.distDir, this.buildId, pathname, serverless);
    }
    ...
    renderToHTMLWithComponents(req, res, pathname, query = {}, result, opts) {
        // handle static page
        ...
        if (!isSpr) {
            ...
            if (isLikeServerless) {
                ...
                req.url = url_1.format(Object.assign(Object.assign({}, curUrl), {query: Object.assign(Object.assign({}, curUrl.query), query)}));
        ...
        spr_cache_1.getSprCache(sprCacheKey);
        if (cachedData) {
        ...
        const doRender = coalesced_function_1.withCoalescedInvoke(async
        ...
        function () {
            ...
            if (isLikeServerless) {
                renderResult = await
                result.Component.renderReqToHTML(req, res, true);
        ...
        if (isOrigin) {
            await
            spr_cache_1.setSprCache(sprCacheKey, {html: html, pageData: sprData}, sprRevalidate);
        }
        return null;
    })
        ;
    ...
    renderToHTML(req, res, pathname, query = {}, {amphtml, dataOnly, hasAmp,} = {}) {
        return this.findPageComponents(pathname, query)
            ...
            return this.renderToHTMLWithComponents(req, res, pathname, result.unstable_getStaticProps
                ...
                : query, result, Object.assign(Object.assign({}, this.renderOpts), {amphtml, hasAmp, dataOnly}));
    },
        err =
    >
        {
            ...
            for (const dynamicRoute of this.dynamicRoutes) {
                ...
                return this.findPageComponents(dynamicRoute.page, query).then(result = > {
                    return this.renderToHTMLWithComponents(req, res, dynamicRoute.page, Object.assign(Object.assign({}, (result.unstable_getStaticProps
                        ? {_nextSprData: query._nextSprData}
                        : query)), params), result, Object.assign(Object.assign({}, this.renderOpts), {
                        amphtml,
                        hasAmp,
                        dataOnly
                    }));
    ...
    renderError(err, req, res, pathname, query = {}) {
        ...
        const html = await
        this.renderErrorToHTML(err, req, res, pathname, query);
        if (html === null) {
            return;
        }
        return this.sendHTML(req, res, html);
    ...
    renderErrorToHTML(err, req, res, _pathname, query = {}) {
        const result = await
        this.findPageComponents('/_error', query);
        let html;
        try {
            html = await
            this.renderToHTMLWithComponents(req, res, '/_error', query, result, Object.assign(Object.assign({}, this.renderOpts), {err}));
        } catch (err) {
            console.error(err);
            res.statusCode = 500;
    ...
    serveStatic(req, res, path, parsedUrl) {
        ...
        try {
            await
            serve_static_1.serveStatic(req, res, path);
        } catch (err) {
