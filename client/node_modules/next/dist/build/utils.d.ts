...
export declare function printTreeView(list: readonly

string[], pageInfos
:
Map < string, PageInfo >, serverless
:
boolean, {distPath, pagesDir, pageExtensions, buildManifest, isModern,}
:
{
    distPath: string;
    pagesDir: string;
...
export declare function getSharedSizes(distPath: string, buildManifest: BuildManifestShape, isModern: boolean, pageInfos: Map<string, PageInfo>): Promise<{
    total: number;
    files: {
        [page: string]: number;
    };
...
export declare function getPageSizeInKb(page: string, distPath: string, buildId: string, buildManifest: BuildManifestShape, isModern: boolean): Promise<number>;
