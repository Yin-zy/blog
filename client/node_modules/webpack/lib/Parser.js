...
class Parser extends Tapable {
    constructor(options, sourceType = "auto") {
        ...
        statement: new SyncBailHook(["statement"]),
            statementIf
    :
        new SyncBailHook(["statement"]),
            label
    :
        new HookMap(() = > new SyncBailHook(["statement"])
    ),
        import
    :
        new SyncBailHook(["statement", "source"]),
            importSpecifier
    :
        new SyncBailHook([
            "statement",
    ...
    :
        new SyncBailHook(["statement", "source"]),
            exportDeclaration
    :
        new SyncBailHook(["statement", "declaration"]),
            exportExpression
    :
        new SyncBailHook(["statement", "declaration"]),
            exportSpecifier
    ...
    :
        new SyncBailHook([
            ...
            varDeclaration
    :
        new HookMap(() = > new SyncBailHook(["declaration"])
    ),
        ...
        typeof
    :
        new HookMap(() = > new SyncBailHook(["expression"])
    ),
    ...
    >
        ...
        this.hooks.evaluateCallExpressionMember
            ...
            .tap("Parser", (expr, param) = > {
            if(
        !param.isString() && !param.isWrapped()
    )
        return;
