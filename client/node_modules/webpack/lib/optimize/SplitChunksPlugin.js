...
const INITIAL_CHUNK_FILTER = chunk =
>
chunk.canBeInitial();
const ASYNC_CHUNK_FILTER = chunk =
>
!chunk.canBeInitial();
const ALL_CHUNK_FILTER = chunk =
>
true;
    ...
    static normalizeCacheGroups({
        ...
        if (typeof cacheGroups === "function") {
            ...
            if (cacheGroups.length !== 1) {
                return module =
            >
                cacheGroups(module, module.getChunks());
            }
            return cacheGroups;
        }
                ...
                for (const key of Object.keys(cacheGroups)) {
                    ...
                    if (typeof option === "function") {
                        ...
                        results.push({
                            ...
                            chunksFilter
                    :
                        SplitChunksPlugin.normalizeChunksFilter(
                            option.chunks
                        ),
                            enforce
                    :
                    ...
                    :
                        option.minChunks,
                            maxAsyncRequests
                    :
                        option.maxAsyncRequests,
                            maxInitialRequests
                    :
                        option.maxInitialRequests,
                            filename
                    :
                        option.filename,
                            reuseExistingChunk
                    :
                        option.reuseExistingChunk
                    })
                        ;
                    }
                }
